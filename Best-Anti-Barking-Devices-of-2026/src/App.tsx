        ...
        <section className="mb-12">
          <div className="grid md:grid-cols-7 gap-8 items-center">
            <div className="md:col-span-5 text-center md:text-left">
              ...
              <p className="text-lg text-slate-700 leading-relaxed max-w-2xl mx-auto md:mx-0">
            ...
            <div className="md:col-span-2">
              <img src="/images/anti-bark-devices-hero.jpg" alt="A collection of the best anti-bark devices on a grassy lawn." className="rounded-lg shadow flex-shrink-0 w-full" />
            </div>
          </div>
        </section>
          ...
          <section id="in-depth" className="space-y-10 scroll-mt-28">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6">
                <img src="/images/review-1.webp" alt="NoBarkUltra" className="w-full h-40 md:h-48 object-cover rounded-lg shadow-sm border border-slate-200 hover:opacity-90 transition-opacity cursor-pointer" />
                <img src="/images/review-2.webp" alt="Attentive dog getting trained" className="w-full h-40 md:h-48 object-cover rounded-lg shadow-sm border border-slate-200 hover:opacity-90 transition-opacity cursor-pointer" />
                <img src="/images/review-3.webp" alt="Dog looking attentively outdoors" className="w-full h-40 md:h-48 object-cover rounded-lg shadow-sm border border-slate-200 hover:opacity-90 transition-opacity cursor-pointer hidden md:block" />
              </div>
